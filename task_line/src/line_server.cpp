...
public:
	TaskLineInnerClass(std::string name, std::string node, std::string node1, std::string node2)
...
int main(int argc, char **argv)
{
	...
	TaskLineInnerClass taskLineObject(ros::this_node::getName(),"forward", "turnXY", "sideward");
	ros::spin();
	return 0;
}
